...
6. The file index.html contains an example on how to incorporate the WebDig app in a web-site by creating a login form. You can change this to meet your needs.
